...
<style src='./terms.scss' lang='scss' scoped></style>
...
<template>
  <div class="page-base">
    <div class="container">
      ...
      <div class="title-common">{{ t('title.certificates') }}</div>

      <ContentQuery path="certificates" :locale="locale" find="one">
