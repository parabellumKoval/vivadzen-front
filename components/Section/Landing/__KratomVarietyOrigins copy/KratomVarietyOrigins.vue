...
<template>
  <div class="kratom-variety-section__origins">
    <div class="kratom-variety-section__subtitle">Откройте для себя разнообразие сортов кратома из разных уголков мира:</div>
    <div class="origins-ribbon">
      <article v-for="origin in origins" :key="origin.name" class="origin-card">
        <p class="origin-card__name">{{ origin.name }}</p>
        <div class="origin-card__video-frame">
          <!-- <video
            :src="origin.video"
            autoplay
            loop
