...
<template>
  <section class="google-reviews">
    ...
    <div class="container">
      <div class="google-reviews__header">
        <div class="google-reviews__header-content">
          <div class="google-reviews__google-badge">
            <IconCSS name="logos:google-icon" class="google-reviews__google-icon" />
            <span class="google-reviews__google-text">Google</span>
          </div>
        ...
        <div v-if="meta" class="google-reviews__stats">
          <div class="google-reviews__rating">
            <span class="google-reviews__rating-value">{{ averageRating.toFixed(1) }}</span>
            <div class="google-reviews__stars">
              <IconCSS 
                v-for="i in 5" 
                :key="i"
                name="ph:star-fill"
                class="google-reviews__star"
                :class="getStarClass(Math.round(averageRating), i)"
              />
            </div>
          </div>
          <p class="google-reviews__total">
      ...
      <!-- CTA -->
      <div class="google-reviews__cta">
        <p class="google-reviews__cta-text">{{ t('cta_text') }}</p>
        <a 
          href="https://g.page/r/YOUR_GOOGLE_REVIEW_LINK/review" 
          target="_blank" 
          rel="noopener noreferrer"
          class="google-reviews__cta-button"
        >
